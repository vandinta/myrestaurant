            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(keranjang, index) in keranjangs" :key="keranjang.id">
                  ...
                  <td>
                    <img
                      :src=" '../assets/img/' + keranjang.foods.gambar "
                  ...
                  <td align="right">Rp. {{ keranjang.foods.harga }}</td>
                  <td align="right">
                    <strong>Rp. {{ keranjang.foods.harga*keranjang.jumlah_pemesanan }}</strong>
                  </td>
      ...
      if (this.order.nama && this.order.noMeja) {
        ...
        axios
          ...
          .then(() => {
            ...
            this.$toast.success("Berhasil Mengorder Menu", {
              type: "success",
              position: "top-right",
              duration: 3000,
              dismissible: true,
